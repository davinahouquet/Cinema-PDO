...
CREATE DATABASE IF NOT EXISTS `cinema_v2` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `cinema_v2`;

-- Listage de la structure de table cinema_v2. acteur
...
-- Listage des données de la table cinema_v2.acteur : ~24 rows (environ)
...
-- Listage de la structure de table cinema_v2. categoriser
...
-- Listage des données de la table cinema_v2.categoriser : ~64 rows (environ)
...
-- Listage de la structure de table cinema_v2. film
...
-- Listage des données de la table cinema_v2.film : ~21 rows (environ)
...
-- Listage de la structure de table cinema_v2. genre
...
-- Listage des données de la table cinema_v2.genre : ~15 rows (environ)
...
-- Listage de la structure de table cinema_v2. jouer
...
-- Listage des données de la table cinema_v2.jouer : ~50 rows (environ)
...
-- Listage de la structure de table cinema_v2. personne
...
-- Listage des données de la table cinema_v2.personne : ~31 rows (environ)
...
-- Listage de la structure de table cinema_v2. realisateur
...
-- Listage des données de la table cinema_v2.realisateur : ~7 rows (environ)
...
-- Listage de la structure de table cinema_v2. role
...
-- Listage des données de la table cinema_v2.role : ~27 rows (environ)
